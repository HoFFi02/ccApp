...
CREATE TABLE IF NOT EXISTS `ccApp`.`przepisy` (
  ...
  `nazwa` VARCHAR(45) NOT NULL,
  `sposob_przygotowania` VARCHAR(5000) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ccApp`.`dzien` (
  ...
  `posilek_id_posilek` INT(11) NULL DEFAULT NULL,
  `przepisy_id_przepisy` INT(11) NULL DEFAULT NULL,
